...
def travshacl(KG, constraints, kg):
    """
    ...
    Args:
        KG: Endpoint of the knowledge graph to validate against.
...
KG = "../KG/DB100K/DB100K.nt"
constraints = "../Constraints/db100k"
kg = "DB100K"

# Initialize RDF graph
g = Graph()
g.parse(KG, format='nt')

travshacl(g, constraints, kg)